# ============================================================
# VPC - Public subnets for EC2 nodes, private subnets for Fargate
# VPC Endpoints reduce AWS service traffic; NAT Gateway is used for external endpoints.
# ============================================================
...
# ============================================================
# Private Subnets for Fargate (no IGW route, uses VPC Endpoints)
# ============================================================
...
# NAT Gateway — enables Fargate pods (private subnets) to reach internet
# Required for New Relic APM (collector.newrelic.com) and public container registries
